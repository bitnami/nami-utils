 ...
 * @param {boolean} [options.compact=true] - Return only the filename instead of filename and additional information of the file.
...
function listDirContents(prefix, options) {
  ...
  options = _.sanitize(options, {stripPrefix: false, includeTopDir: false, compact: true, getAllAttrs: false, include: ['*'], exclude: [], onlyFiles: false, rootDir: null, prefix: null, followSymLinks: false, listSymLinks: true});
  const results = [];
